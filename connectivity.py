...
insert_values("Adhi","8774577646") # change the values
update_record(1,"Dinesh","485124545") # change the values
delete_values([5]) #delete the data from table
view_values() #To check values in table
method.close()
conn.close()
